...
<form action="<?php echo url('add'); ?>" method="POST" enctype="multipart/form-data">
	<table style="width: 69%;">
		...
		<tr>
			...
			<input type="text" style="width: 170px;height:28px;position: relative;right: 258px;" id="text" class="filetext"/>
		...
		<td>
			<select name="detail_image">
				<option value="1">车机详情</option>
				<option value="2">云镜详情</option>
			</select>
		</td>
	</tr>
		<tr>

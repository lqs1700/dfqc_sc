<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\wamp64\www\dfqc_sc\public/../application/index\view\category\index.html";i:1528773012;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<table cellspacing="1">
    ...
    <tr>
        ...
        <td><a href="<?php echo url('del'); ?>?id=<?php echo $value['id']; ?>&&img_id=<?php echo $value['top_image_id']; ?>">删除</a></td>
    </tr>
